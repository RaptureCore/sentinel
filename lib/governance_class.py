...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to raptured "gobject list" output
    ...
    def raptured_serialise(self):
        import rapturelib
        return rapturelib.SHIM_serialise_for_raptured(self.serialise())
